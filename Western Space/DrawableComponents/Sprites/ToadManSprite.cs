...
{
    /// <summary>
    /// Animates Toadman using the appropriate animation data
    /// </summary>
    public class ToadManSprite : AnimatedComponent
    {
        /// <summary>
        /// The name of the asset that has the animation data for this sprite
        /// </summary>
        private static string xmlAssetName = "SpriteXML\\ToadMan";
        ...
        {
            get { return ToadManSprite.xmlAssetName; }
        }
        ...
        {
            get { return ToadManSprite.spriteBatchName; }
        }
        ...
        public ToadManSprite(Game game, SpriteBatch spriteBatch, Vector2 position, AnimationData data)
        ...
        {
            this.SpriteBatch.Draw(this.AnimationData.SpriteSheet, this.Position, this.CalculateFrameRectangleFromIndex(this.CurrentFrame.SheetIndex), Color.White);
