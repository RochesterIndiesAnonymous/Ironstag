...
namespace WesternSpace.DrawableComponents.Sprites
{
    ...
    public class ToadManSprite : AnimatedComponent
    {
        ...
        public ToadManSprite(Game game, SpriteBatch spriteBatch, AnimationData data)
        ...
        {
            this.SpriteBatch.Draw(this.AnimationData.SpriteSheet, new Vector2(1394, 260), this.CalculateFrameRectangleFromIndex(this.CurrentFrame.SheetIndex), Color.White);
