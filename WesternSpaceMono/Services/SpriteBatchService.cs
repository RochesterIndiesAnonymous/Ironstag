...
namespace WesternSpace.Services
{
    ...
    public class SpriteBatchService : GameComponent, ISpriteBatchService
    {
        ...
        public override void Initialize()
        {
            ...
            SpriteBatchDescription cameraSensitive = new SpriteBatchDescription("Camera Sensitive", BlendState.AlphaBlend, SpriteSortMode.Deferred,
                 true);
            ...
            SpriteBatchDescription staticBatchDescription = new SpriteBatchDescription("Static", BlendState.AlphaBlend, SpriteSortMode.Deferred,
                 false);
        ...
        public void Begin()
        {
            foreach (SpriteBatch batch in batches.Keys)
            {
                ...
                //batch.Begin(desc.DesiredBlendMode, desc.DesiredSortMode);
            }
        }
