...
namespace WesternSpace.DrawableComponents.EditorUI
{
    public class SubTextureSelector : EditorUIComponent, ITilePropertyComponent
    {
...

        {
            ...
            PrimitiveDrawer.Instance.DrawSolidRect(this.SpriteBatch, rect, new Microsoft.Xna.Framework.Color(0,255,0));

            if (isSelectingSubTexture) // User is selecting a subtexture from us...
            {
                this.SpriteBatch.Draw(selectingSheet.Texture, Position, Microsoft.Xna.Framework.Color.White);
                if (MouseIsInside())
                {
                    ...
                    PrimitiveDrawer.Instance.DrawRect(SpriteBatch, rect, Microsoft.Xna.Framework.Color.White);
                }
                ...
                { 
                    ...
                    PrimitiveDrawer.Instance.DrawRect(SpriteBatch, rect, Microsoft.Xna.Framework.Color.CornflowerBlue);
                }
            }
            else // Waiting for user to activate us...
            {
                ...
                else
                {
                    ...
                    {
                        col = new Microsoft.Xna.Framework.Color(255, 0, 255);
                    }
                    else
                    {
                        col = new Microsoft.Xna.Framework.Color(255, 255, 255);
                    }
